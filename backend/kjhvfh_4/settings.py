"""
Django settings for kjhvfh_4 project.
...
WSGI_APPLICATION = 'kjhvfh_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kjhvfh_4 API",
    "DESCRIPTION": "API documentation for kjhvfh_4 App",
    "VERSION": "v1",
}
